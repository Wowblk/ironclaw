...
let threadId=sessionStorage.getItem('ironclaw_thread')||null;
        ...
        if(line.startsWith('event:')){evtName=line.slice(6).trim();}
          ...
          try{
            ...
            if(evtName==='done'&&d.thread_id){
              ...
              sessionStorage.setItem('ironclaw_thread',threadId);
            }
...
class WebGateway:
    ...
    def _tool_defs(self) -> list[Any]:
        from ironclaw.state import ToolDefinition
    ...
    def _build_app(self) -> FastAPI:
        app = FastAPI(title="IronClaw Web Gateway", docs_url=None, redoc_url=None)
