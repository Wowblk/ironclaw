...
Usage::
    ...
    ws = SupermemoryWorkspace(
        ...
        container_tag="titanclaw",      # namespace per user / deployment
    )
...
class SupermemoryWorkspace(Workspace):
    ...
    container_tag:
        ...
        values to keep memories isolated.  Defaults to ``"titanclaw"``.
    """
    ...
    def __init__(self, api_key: str, container_tag: str = "titanclaw") -> None:
        super().__init__()
